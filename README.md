...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bm5tobm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bm5tobm.containers.anotherwebservice.com/
...
```
git clone git@github.com:hujingwen1025/container-bm5tobm.git
cd container-bm5tobm
```
...
```
docker attach container-bm5tobm
```
